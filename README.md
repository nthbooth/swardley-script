...
Copy the URL from the current webapp URL. (example: [URL published json](https://script.google.com/macros/s/AKfycbz42KAy6M65nvRitvK1HbOG0Z77PnHCgC0JiUsM/exec)
